...
function ClaudeLobster({ size = 40, animate = false, style = {} }) {
  ...
  const a = animate;
  return (
    <svg viewBox="0 0 16 16" width={size} height={size} style={{ animation: a ? "lobsterBob 1.2s ease-in-out infinite" : "none", imageRendering: "pixelated", ...style }} xmlns="http://www.w3.org/2000/svg" shapeRendering="crispEdges">
      <g style={{ animation: a ? "antennaWiggleL 2s ease-in-out infinite" : "none", transformOrigin: "5px 3px" }}>
      ...
      <g style={{ animation: a ? "antennaWiggleR 2s ease-in-out infinite" : "none", transformOrigin: "10px 3px" }}>
      ...
      <g style={{ animation: a ? "clawSnapL 1.5s ease-in-out infinite" : "none", transformOrigin: "3px 7px" }}>
      ...
      <g style={{ animation: a ? "clawSnapR 1.5s ease-in-out infinite 0.3s" : "none", transformOrigin: "12px 7px" }}>
      ...
      {[0,1,2].map(i=>(
        <g key={i}>
          <rect x={3-i} y={10+i} width={P} height={P} fill="#D16A4A" style={{animation:a?`legWiggle 0.8s ease-in-out infinite ${i*0.15}s`:"none",transformOrigin:"5px 10px"}} />
          <rect x={12+i} y={10+i} width={P} height={P} fill="#D16A4A" style={{animation:a?`legWiggle 0.8s ease-in-out infinite ${i*0.15+0.4}s`:"none",transformOrigin:"10px 10px"}} />
        </g>
      ))}
      <g style={{ animation: a ? "tailFlick 2s ease-in-out infinite" : "none", transformOrigin: "8px 13px" }}>
        <rect x={7} y={13} width={P} height={P} fill="#C05A3A" /><rect x={8} y={13} width={P} height={P} fill="#C05A3A" />
        <rect x={6} y={14} width={P} height={P} fill="#C05A3A" /><rect x={7} y={14} width={P} height={P} fill="#D16A4A" /><rect x={8} y={14} width={P} height={P} fill="#D16A4A" /><rect x={9} y={14} width={P} height={P} fill="#C05A3A" />
        <rect x={5} y={15} width={P} height={P} fill="#C05A3A" /><rect x={6} y={15} width={P} height={P} fill="#D16A4A" /><rect x={9} y={15} width={P} height={P} fill="#D16A4A" /><rect x={10} y={15} width={P} height={P} fill="#C05A3A" />
      </g>
      <rect x={6} y={3} width={P} height={P} fill="#E87F5F" /><rect x={7} y={3} width={P} height={P} fill="#E87F5F" /><rect x={8} y={3} width={P} height={P} fill="#E87F5F" /><rect x={9} y={3} width={P} height={P} fill="#E87F5F" />
      <rect x={5} y={4} width={P} height={P} fill="#E87F5F" /><rect x={6} y={4} width={P} height={P} fill="#1a1a2e" /><rect x={7} y={4} width={P} height={P} fill="#F4A683" /><rect x={8} y={4} width={P} height={P} fill="#F4A683" /><rect x={9} y={4} width={P} height={P} fill="#1a1a2e" /><rect x={10} y={4} width={P} height={P} fill="#E87F5F" />
      <rect x={5} y={5} width={P} height={P} fill="#E87F5F" /><rect x={6} y={5} width={P} height={P} fill="#E87F5F" /><rect x={7} y={5} width={P} height={P} fill="#D16A4A" /><rect x={8} y={5} width={P} height={P} fill="#D16A4A" /><rect x={9} y={5} width={P} height={P} fill="#E87F5F" /><rect x={10} y={5} width={P} height={P} fill="#E87F5F" />
      {[4,5,6,7,8,9,10,11].map(x=><rect key={`r6-${x}`} x={x} y={6} width={P} height={P} fill="#E87F5F" />)}
      <rect x={3} y={7} width={P} height={P} fill="#E87F5F" /><rect x={5} y={7} width={P} height={P} fill="#D16A4A" /><rect x={6} y={7} width={P} height={P} fill="#E87F5F" /><rect x={7} y={7} width={P} height={P} fill="#E87F5F" /><rect x={8} y={7} width={P} height={P} fill="#E87F5F" /><rect x={9} y={7} width={P} height={P} fill="#E87F5F" /><rect x={10} y={7} width={P} height={P} fill="#D16A4A" /><rect x={12} y={7} width={P} height={P} fill="#E87F5F" />
      <rect x={5} y={8} width={P} height={P} fill="#E87F5F" /><rect x={6} y={8} width={P} height={P} fill="#F4A683" /><rect x={7} y={8} width={P} height={P} fill="#E87F5F" /><rect x={8} y={8} width={P} height={P} fill="#E87F5F" /><rect x={9} y={8} width={P} height={P} fill="#F4A683" /><rect x={10} y={8} width={P} height={P} fill="#E87F5F" />
      <rect x={5} y={9} width={P} height={P} fill="#E87F5F" /><rect x={6} y={9} width={P} height={P} fill="#E87F5F" /><rect x={7} y={9} width={P} height={P} fill="#D16A4A" /><rect x={8} y={9} width={P} height={P} fill="#D16A4A" /><rect x={9} y={9} width={P} height={P} fill="#E87F5F" /><rect x={10} y={9} width={P} height={P} fill="#E87F5F" />
      <rect x={5} y={10} width={P} height={P} fill="#D16A4A" /><rect x={6} y={10} width={P} height={P} fill="#E87F5F" /><rect x={7} y={10} width={P} height={P} fill="#E87F5F" /><rect x={8} y={10} width={P} height={P} fill="#E87F5F" /><rect x={9} y={10} width={P} height={P} fill="#E87F5F" /><rect x={10} y={10} width={P} height={P} fill="#D16A4A" />
      <rect x={6} y={11} width={P} height={P} fill="#E87F5F" /><rect x={7} y={11} width={P} height={P} fill="#D16A4A" /><rect x={8} y={11} width={P} height={P} fill="#D16A4A" /><rect x={9} y={11} width={P} height={P} fill="#E87F5F" />
      <rect x={6} y={12} width={P} height={P} fill="#D16A4A" /><rect x={7} y={12} width={P} height={P} fill="#E87F5F" /><rect x={8} y={12} width={P} height={P} fill="#E87F5F" /><rect x={9} y={12} width={P} height={P} fill="#D16A4A" />
    </svg>
  );
}
...
function Toast({ message, type, onDone }) {
  ...
  const s = type==="error"?{bg:"#7f1d1d",border:"#ef4444",color:"#fca5a5",icon:"✕"}:type==="success"?{bg:"#14532d",border:"#22c55e",color:"#86efac",icon:"✓"}:{bg:"#1e293b",border:"#3b82f6",color:"#93c5fd",icon:"◈"};
  return (<div style={{position:"fixed",bottom:24,left:"50%",transform:"translateX(-50%)",background:s.bg,border:`1px solid ${s.border}`,borderRadius:12,padding:"12px 20px",color:s.color,fontSize:13,fontWeight:600,zIndex:9999,boxShadow:`0 8px 32px rgba(0,0,0,0.5),0 0 16px ${s.border}33`,animation:"slideUp 0.3s ease-out",maxWidth:"90vw",textAlign:"center",display:"flex",alignItems:"center",gap:8,backdropFilter:"blur(8px)"}}><span style={{fontSize:16}}>{s.icon}</span> {message}</div>);
}
...
function CopyButton({ text, label }) {
  ...
  const rip = useRipple();
  const handleCopy = async (e) => { rip(e); const r = await copyToClipboard(text); if(r==="ok"){setState("copied");setTimeout(()=>setState("idle"),2500);}else{setState("fallback");setShowModal(true);setTimeout(()=>setState("idle"),3000);} };
  ...
  return (<><button onClick={handleCopy} className="btn-ripple tap-bounce focus-ring" style={{background:c.bg,color:c.color,border:`1px solid ${c.border}`,borderRadius:6,padding:"6px 14px",fontSize:12,cursor:"pointer",transition:"all 0.2s",fontFamily:"inherit",fontWeight:600,whiteSpace:"nowrap",touchAction:"manipulation"}}>{state==="copied"?"✓ Copied!":state==="fallback"?"Tap to select ↗":(label||"Copy")}</button>{showModal && <FallbackModal text={text} onClose={()=>setShowModal(false)} />}</>);
}
...
function CharCounter({ count, limit, label }) {
  ...
  return (<div style={{display:"flex",alignItems:"center",gap:8,fontSize:12,color:"#94a3b8"}}>{label && <span style={{minWidth:36}}>{label}</span>}<div style={{flex:1,height:4,background:"#1e293b",borderRadius:2,overflow:"hidden"}}><div style={{width:`${pct*100}%`,height:"100%",background:color,borderRadius:2,transition:"width 0.3s",boxShadow:count>limit*0.85?`0 0 6px ${color}66`:"none"}} /></div><span style={{color,fontWeight:600,minWidth:60,textAlign:"right",fontFamily:"monospace",fontSize:11}}>{count}/{limit}</span></div>);
}
    ...
    <div className="hover-lift" style={{background:"linear-gradient(145deg,#0f172a,#0c1322)",border:`1px solid ${over?"#ef4444":"#1e293b"}`,borderRadius:14,padding:20,display:"flex",flexDirection:"column",gap:12,transition:"all 0.25s ease",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8}}>
        ...
        <div style={{display:"flex",gap:6}}>
          {!editing ? (<button onClick={e=>{rip(e);handleEdit();}} className="btn-ripple tap-bounce focus-ring hover-border" style={{background:"#1e293b",color:"#94a3b8",border:"1px solid #334155",borderRadius:6,padding:"6px 14px",fontSize:12,cursor:"pointer",fontFamily:"inherit",fontWeight:600,touchAction:"manipulation"}}>✏️ Edit</button>) : (<button onClick={e=>{rip(e);handleSave();}} className="btn-ripple tap-bounce focus-ring" style={{background:"#166534",color:"#4ade80",border:"1px solid #22c55e",borderRadius:6,padding:"6px 14px",fontSize:12,cursor:"pointer",fontFamily:"inherit",fontWeight:600,touchAction:"manipulation"}}>✓ Done</button>)}
          <CopyButton text={text} />
        </div>
      </div>
      {editing ? (<textarea ref={taRef} value={text} onChange={e=>setText(e.target.value)} className="focus-ring" style={{background:"#020617",border:`1px solid ${over?"#ef4444":"#334155"}`,borderRadius:8,color:"#e2e8f0",padding:16,fontSize:15,lineHeight:1.75,minHeight:120,resize:"vertical",fontFamily:"Georgia,serif",width:"100%",boxSizing:"border-box",outline:"none",transition:"border-color 0.3s"}} />) : (<div onClick={handleEdit} className="hover-border" style={{background:"#020617",borderRadius:8,padding:16,color:"#cbd5e1",fontSize:15,lineHeight:1.75,whiteSpace:"pre-wrap",fontFamily:"Georgia,serif",cursor:"text",WebkitUserSelect:"text",userSelect:"text",border:"1px solid transparent",transition:"all 0.2s"}}>{text}</div>)}
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:16,alignItems:"center"}}>
      <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:12,padding:"32px 24px",background:"linear-gradient(145deg,#0f172a,#0c1322)",border:"1px solid #1e293b",borderRadius:16,width:"100%",boxSizing:"border-box",animation:"glow 2s ease-in-out infinite"}}>
        ...
        <div style={{display:"flex",gap:4,alignItems:"center"}}>{[0,1,2].map(i=><div key={i} style={{width:6,height:6,borderRadius:3,background:"#3b82f6",animation:`pulse 1s ease-in-out infinite ${i*0.2}s`}} />)}</div>
      </div>
      {[1,2].map(i=>(<div key={i} style={{background:"linear-gradient(145deg,#0f172a,#0c1322)",border:"1px solid #1e293b",borderRadius:14,padding:20,width:"100%",boxSizing:"border-box"}}>{[1,0.75,0.5].map((_,j)=><div key={j} style={{height:12,width:`${_*100}%`,borderRadius:6,marginBottom:12,background:"linear-gradient(90deg,#1e293b 25%,#2a3a52 50%,#1e293b 75%)",backgroundSize:"400px 100%",animation:`shimmer 1.5s infinite linear ${j*0.15}s`}} />)}</div>))}
    </div>
  );
}
    ...
    <div style={{display:"flex",flexDirection:"column",gap:12}}>
      <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap"}}>
        ...
        <div style={{display:"flex",gap:6,flex:1,flexWrap:"wrap"}}>
          {MODELS.map(m=>{const act=model===m.id;return (<button key={m.id} onClick={e=>{rip(e);setModel(m.id);}} className={`btn-ripple tap-bounce focus-ring ${act?"":"hover-glow"}`} style={{padding:"8px 16px",borderRadius:10,border:"1px solid",borderColor:act?"#3b82f6":"#1e293b",background:act?"linear-gradient(135deg,#1d3461,#172554)":"#0f172a",color:act?"#93c5fd":"#64748b",fontSize:12,cursor:"pointer",fontFamily:"inherit",fontWeight:act?700:500,touchAction:"manipulation",transition:"all 0.2s",display:"flex",alignItems:"center",gap:6,boxShadow:act?"0 0 12px rgba(59,130,246,0.15)":"none"}}><span style={{fontSize:14}}>{m.icon}</span><span>{m.label}</span><span style={{fontSize:10,color:act?"#60a5fa":"#475569",fontWeight:400}}>({m.desc})</span></button>);})}
        </div>
      </div>
      <div style={{display:"flex",alignItems:"center",gap:12}}>
        ...
        <button onClick={e=>{rip(e);setThinking(!thinking);}} className="btn-ripple tap-bounce focus-ring" style={{width:48,height:26,borderRadius:13,border:"1px solid",padding:2,cursor:"pointer",background:thinking?"linear-gradient(135deg,#7c3aed,#a855f7)":"#1e293b",borderColor:thinking?"#a855f7":"#334155",transition:"all 0.3s ease",display:"flex",alignItems:"center",boxShadow:thinking?"0 0 12px rgba(168,85,247,0.3)":"none"}}><div style={{width:20,height:20,borderRadius:10,background:thinking?"#fff":"#475569",transform:thinking?"translateX(22px)":"translateX(0)",transition:"all 0.3s cubic-bezier(0.34,1.56,0.64,1)",boxShadow:thinking?"0 1px 4px rgba(0,0,0,0.3)":"none"}} /></button>
        <span style={{color:thinking?"#c4b5fd":"#475569",fontSize:12,fontWeight:thinking?600:400,transition:"all 0.2s"}}>Extended Thinking {thinking && <span style={{color:"#a855f7",fontSize:10}}>(deeper reasoning)</span>}</span>
      </div>
    </div>
  );
}
...
function HistoryPanel({ history, onSelect, onClose }) {
  const rip = useRipple();
  if (!history.length) return (<div style={{padding:24,textAlign:"center",color:"#475569",fontSize:13}}><span style={{fontSize:24,display:"block",marginBottom:8,opacity:0.5}}>📋</span>No posts generated yet.</div>);
  return (
    <div className="scrollbar-thin" style={{display:"flex",flexDirection:"column",gap:8,padding:"8px 0",maxHeight:300,overflowY:"auto"}}>
      {history.map((item,i)=>(<button key={i} onClick={e=>{rip(e);onSelect(item);onClose();}} className="btn-ripple tap-bounce hover-glow focus-ring" style={{background:"#0f172a",border:"1px solid #1e293b",borderRadius:10,padding:"14px 16px",cursor:"pointer",textAlign:"left",fontFamily:"inherit",display:"flex",flexDirection:"column",gap:6,transition:"all 0.2s",touchAction:"manipulation",position:"relative",overflow:"hidden"}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><span style={{color:"#3b82f6",fontSize:11,fontWeight:700}}>{item.inputs.topic} · {item.inputs.tone}</span><span style={{color:"#334155",fontSize:10,fontFamily:"monospace"}}>{item.timestamp}</span></div><div style={{color:"#94a3b8",fontSize:12,lineHeight:1.5,overflow:"hidden",display:"-webkit-box",WebkitLineClamp:2,WebkitBoxOrient:"vertical"}}>{item.inputs.content.slice(0,120)}{item.inputs.content.length>120?"…":""}</div><div style={{color:"#475569",fontSize:11}}>𝕏 {item.result.twitter.length} chars · 🧵 {item.result.threads.length} chars</div></button>))}
    </div>
  );
}
...
export default function SocialPostGenerator() {
  ...
  useEffect(()=>{const h=e=>{if((e.metaKey||e.ctrlKey)&&e.key==="Enter"){e.preventDefault();document.getElementById("generate-btn")?.click();}};window.addEventListener("keydown",h);return()=>window.removeEventListener("keydown",h);},[]);
    ...
    <div style={{minHeight:"100vh",background:"linear-gradient(180deg,#020617 0%,#0a0f1e 50%,#020617 100%)",color:"#e2e8f0",fontFamily:"'DM Sans','Segoe UI',sans-serif",padding:"32px 16px"}}>
      ...
      <div style={{maxWidth:720,margin:"0 auto"}}>
        <div style={{marginBottom:28,textAlign:"center"}}>
          <div style={{fontSize:10,letterSpacing:"0.25em",color:"#3b82f6",fontWeight:700,textTransform:"uppercase",marginBottom:14,display:"flex",alignItems:"center",justifyContent:"center",gap:8}}><span style={{width:24,height:1,background:"linear-gradient(90deg,transparent,#3b82f6)"}} />SOCIAL POST GENERATOR<span style={{width:24,height:1,background:"linear-gradient(90deg,#3b82f6,transparent)"}} /></div>
        ...
        <div style={{display:"flex",gap:8,marginBottom:16,flexWrap:"wrap",alignItems:"center"}}>
          ...
          <button style={toolbarBtn(showHistory)} onClick={e=>{rip(e);setShowHistory(!showHistory);setShowPresets(false);}} className="btn-ripple tap-bounce focus-ring">📋 History{history.length>0 && <span style={{background:"linear-gradient(135deg,#3b82f6,#2563eb)",color:"#fff",fontSize:10,fontWeight:700,borderRadius:10,padding:"1px 6px",minWidth:16,textAlign:"center"}}>{history.length}</span>}</button>
          <div style={{flex:1}} /><span style={{color:"#1e293b",fontSize:11,fontFamily:"monospace"}}>⌘+Enter</span>
        </div>

        {showPresets && (<div style={{background:"linear-gradient(145deg,#0a1628,#0c1322)",border:"1px solid #1e293b",borderRadius:14,padding:14,marginBottom:16,display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(155px,1fr))",gap:8,animation:"fadeIn 0.2s ease-out"}}>{PRESETS.map((p,i)=><button key={i} onClick={e=>{rip(e);applyPreset(p);}} className="btn-ripple tap-bounce hover-glow focus-ring" style={{background:"#0f172a",border:"1px solid #1e293b",borderRadius:10,padding:"12px 14px",color:"#94a3b8",fontSize:13,cursor:"pointer",fontFamily:"inherit",textAlign:"left",transition:"all 0.2s",touchAction:"manipulation",position:"relative",overflow:"hidden"}}>{p.label}</button>)}</div>)}

        {showHistory && (<div style={{background:"linear-gradient(145deg,#0a1628,#0c1322)",border:"1px solid #1e293b",borderRadius:14,padding:14,marginBottom:16,animation:"fadeIn 0.2s ease-out"}}><HistoryPanel history={history} onSelect={loadHistoryItem} onClose={()=>setShowHistory(false)} /></div>)}
        ...
        <div style={{display:"flex",flexDirection:"column",gap:22,background:"linear-gradient(145deg,#0a1628,#080e1c)",border:"1px solid #1e293b",borderRadius:18,padding:"28px 22px",marginBottom:24,position:"relative",overflow:"hidden"}}>
          ...
          <div><label style={labelStyle}>Topic Category</label><div style={{display:"flex",flexWrap:"wrap",gap:8}}>{TOPICS.map(t=><button key={t} style={pill(topic===t)} onClick={e=>{rip(e);setTopic(t);}} className="btn-ripple tap-bounce focus-ring">{t}</button>)}</div>{topic==="Custom" && <input style={{...inputStyle,marginTop:10}} className="focus-ring" placeholder="Enter your custom topic..." value={customTopic} onChange={e=>setCustom(e.target.value)} />}</div>

          <div><label style={labelStyle}>Tone</label><div style={{display:"flex",flexWrap:"wrap",gap:8}}>{TONES.map(t=><button key={t} style={pill(tone===t)} onClick={e=>{rip(e);setTone(t);}} className="btn-ripple tap-bounce focus-ring">{t}</button>)}</div></div>

          <div><label style={labelStyle}>Hook Technique</label><div style={{display:"flex",flexWrap:"wrap",gap:8}}>{HOOK_TYPES.map(h=><button key={h} style={pill(hookType===h)} onClick={e=>{rip(e);setHookType(h);}} className="btn-ripple tap-bounce focus-ring">{h}</button>)}</div></div>

          <div><label style={labelStyle}>Your Key Message or Content</label><textarea style={{...inputStyle,minHeight:130,resize:"vertical",lineHeight:1.6}} className="focus-ring" placeholder="Paste an article summary, idea, insight, announcement, or talking point." value={content} onChange={e=>setContent(e.target.value)} /><div style={{marginTop:6}}><CharCounter count={content.length} limit={2000} label="Input" /></div></div>

          <div><label style={labelStyle}>Source URL <span style={{color:"#475569",textTransform:"none",letterSpacing:0}}>(optional)</span></label><input style={inputStyle} className="focus-ring" type="url" inputMode="url" placeholder="https://..." value={url} onChange={e=>setUrl(e.target.value)} /></div>
          ...
          <button id="generate-btn" onClick={e=>{rip(e);generate();}} disabled={loading} className="btn-ripple tap-bounce focus-ring" style={{background:loading?"#1e293b":"linear-gradient(135deg,#1d4ed8 0%,#3b82f6 50%,#2563eb 100%)",color:loading?"#475569":"#fff",border:"none",borderRadius:12,padding:"18px 24px",fontSize:16,fontWeight:700,cursor:loading?"not-allowed":"pointer",transition:"all 0.2s",letterSpacing:"0.02em",fontFamily:"inherit",WebkitAppearance:"none",appearance:"none",touchAction:"manipulation",position:"relative",overflow:"hidden",boxShadow:loading?"none":"0 4px 16px rgba(59,130,246,0.25)"}}>
            {loading ? (<span style={{display:"flex",alignItems:"center",justifyContent:"center",gap:8}}><ClaudeLobster size={22} animate={true} />Generating{thinking?" (thinking)…":"…"}</span>) : (<span style={{display:"flex",alignItems:"center",justifyContent:"center",gap:8}}><ClaudeLobster size={20} animate={false} />Generate Posts</span>)}
          </button>
        </div>
        ...
        {result && !loading && (
          <div ref={resultsRef} style={{display:"flex",flexDirection:"column",gap:16,animation:"fadeIn 0.3s ease-out"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8}}>
              <div style={{display:"flex",alignItems:"center",gap:8}}><div style={{color:"#475569",fontSize:10,letterSpacing:"0.2em",textTransform:"uppercase",fontWeight:700}}>◈ Generated Posts</div>{history[0]?.model && <span style={{fontSize:10,color:"#334155",fontFamily:"monospace",background:"#0f172a",padding:"2px 8px",borderRadius:4,border:"1px solid #1e293b"}}>via {history[0].model}</span>}</div>
            ...
            {(result.hashtags||result.source||result.hook) && (<div className="hover-lift" style={{background:"linear-gradient(145deg,#0a1628,#0c1322)",border:"1px solid #1e293b",borderRadius:14,padding:20,display:"flex",flexDirection:"column",gap:10}}>{result.hashtags && <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}><div style={{fontSize:13}}><span style={{color:"#475569",fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.1em"}}>Hashtags · </span><span style={{color:"#3b82f6"}}>{result.hashtags}</span></div><CopyButton text={result.hashtags} label="Copy Tags" /></div>}{result.source && <div style={{fontSize:13}}><span style={{color:"#475569",fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.1em"}}>Source · </span><span style={{color:"#cbd5e1"}}>{result.source}</span></div>}{result.hook && <div style={{fontSize:13}}><span style={{color:"#475569",fontSize:10,fontWeight:700,textTransform:"uppercase",letterSpacing:"0.1em"}}>Hook · </span><span style={{color:"#a78bfa"}}>{result.hook}</span></div>}</div>)}
        ...
        <div style={{marginTop:40,paddingTop:20,borderTop:"1px solid #0f172a",textAlign:"center"}}><p style={{color:"#1e293b",fontSize:11,letterSpacing:"0.05em"}}>Built with Claude · v3.0</p></div>
      </div>
